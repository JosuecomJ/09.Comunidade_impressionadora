...
def login():
    ...
    if form_login.validate_on_submit() and 'botao_submite_login' in request.form:
        ...
        if usuario and bcrypt.check_password_hash(usuario.senha, form_login.senha.data):
            ...
            flash(f'Falha no login, sua senha ou e-mail podem estar incorretos', 'alert-danger')
    if form_criarconta.validate_on_submit() and 'botao_submite_criarconta' in request.form:
        ...
        flash(f' {form_criarconta.username.data} sua conta foi criada com sucesso', 'alert-success')
        return redirect(url_for('home'))
...
def sair():
    logout_user()
    flash(f'Logout feito com suscesso', 'alert-success')
    return redirect(url_for('home'))
